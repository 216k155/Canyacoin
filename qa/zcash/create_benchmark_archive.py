...
ZCASH_CLI = './src/canya-cli'
USAGE = """
Requirements:
- find
- xz
- %s (edit ZCASH_CLI in this script to alter the path)
- A running mainnet canyad using the default datadir with -txindex=1
...
LD_LIBRARY_PATH=src/leveldb python qa/canya/create_benchmark_archive.py
""" % ZCASH_CLI
