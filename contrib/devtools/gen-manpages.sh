...
ZCASHD=${ZCASHD:-$SRCDIR/canyad}
ZCASHCLI=${ZCASHCLI:-$SRCDIR/canya-cli}
ZCASHTX=${ZCASHTX:-$SRCDIR/canya-tx}
...
# This gets autodetected fine for canyad if --version-string is not set,
# but has different outcomes for canya-cli.
