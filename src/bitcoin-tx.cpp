...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Zcash canya-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  canya-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded canya transaction") + "\n" +
              "  canya-tx [options] -create [commands]   " + _("Create hex-encoded canya transaction") + "\n" +
              "\n";
