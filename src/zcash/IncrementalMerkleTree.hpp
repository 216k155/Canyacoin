...
} // end namespace `libcanya`

typedef libcanya::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libcanya::SHA256Compress> ZCIncrementalMerkleTree;
typedef libcanya::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libcanya::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libcanya::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libcanya::SHA256Compress> ZCIncrementalWitness;
typedef libcanya::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libcanya::SHA256Compress> ZCTestingIncrementalWitness;
