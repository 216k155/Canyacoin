...
https://github.com/canya/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libcanya::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libcanya::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;
