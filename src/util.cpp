...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Can
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Can
    // Mac: ~/Library/Application Support/Can
    // Unix: ~/.canya
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Can";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "canya.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override canya.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "canyad.pid"));
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i Can Blockchain Foundation"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
