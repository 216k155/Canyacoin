...
bool CWalletDB::WriteCryptedZKey(const libcanya::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libcanya::PaymentAddress& addr, const libcanya::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 vkValue;
            ssValue >> vkValue;
            libcanya::ViewingKey vk(vkValue);
