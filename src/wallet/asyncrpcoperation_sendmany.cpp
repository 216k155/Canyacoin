...
bool AsyncRPCOperation_sendmany::main_impl() {
    ...
    while (!vpubNewProcessed) {
        ...
        if (jsChange > 0) {
            ...
            auto hSig = prevJoinSplit.h_sig(*pcanyaParams, tx_.joinSplitPubKey);
            try {
        ...
        uint256 anchor)
{
...

    {
        ...
        if (!(jsdesc.Verify(*pcanyaParams, verifier, joinSplitPubKey_))) {
    ...
    std::string encryptedNote2;
    {
        ...
        ss2 << jsdesc.h_sig(*pcanyaParams, joinSplitPubKey_);
