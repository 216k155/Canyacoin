...
public:
    ...
    JSDescription(ZCJoinSplit& params,
            ...
            const uint256& rt,
            const boost::array<libcanya::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libcanya::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
    ...
    bool Verify(
        ZCJoinSplit& params,
        libcanya::ProofVerifier& verifier,
        const uint256& pubKeyHash
    ) const;
