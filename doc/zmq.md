...
router", implementing the canya wire protocol and relay, making
...
For instance:
    ...
    $ canyad -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/canyad.tx.raw
...
From the perspective of canyad, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into canyad directly. Furthermore, no information is
