...
Push the resulting branch to github:
    ...
    $ git push 'git@github.com:$YOUR_GITHUB_NAME/canya' $(git rev-parse --abbrev-ref HEAD)
...
- Run the [Gitian deterministic build environment](https://github.com/canya/canya-gitian)
- Compare the uploaded [build manifests on gitian.sigs](https://github.com/canya/gitian.sigs)
- If all is well, the DevOps engineer will build the Debian packages and update the
  [apt.z.cash package repository](https://apt.z.cash).

## Add release notes to GitHub

- Go to the [GitHub tags page](https://github.com/canya/canya/tags).
...
Then, verify that nodes can connect to the testnet server, and update the guide on the wiki to ensure the correct hostname is listed in the recommended canya.conf.

### Update the 1.0 User Guide

This also means updating [the translations](https://github.com/canya/canya-docs).
Coordinate with the translation team for now. Suggestions for improving this
part of the process should be added to #2596.

### Publish the release announcement (blog, github, canya-dev, slack)
