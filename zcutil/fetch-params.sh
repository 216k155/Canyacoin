...
Failed to fetch the Canyacoin zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Canyacoin - fetch-params.sh

This script will fetch the Canyacoin zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Canyacoin zkSNARK parameters. Note that it is
